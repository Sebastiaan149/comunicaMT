...
const df_819_1 = new (require('@comunica/logger-void').LoggerVoid)();
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_source_identify_hypermedia__5_0_0_components_ActorQuerySourceIdentifyHypermedia_jsonld_ActorQuerySourceIdentifyHypermedia_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-query-source-identify-hypermedia/^5.0.0/components/ActorQuerySourceIdentifyHypermedia.jsonld#ActorQuerySourceIdentifyHypermedia_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__5_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus = new (require('@comunica/bus-query-operation').BusQueryOperation)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-query-operation/^5.0.0/components/ActorQueryOperation.jsonld#ActorQueryOperation_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_context_preprocess__5_0_0_components_ActorContextPreprocess_jsonld_ActorContextPreprocess_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-context-preprocess/^5.0.0/components/ActorContextPreprocess.jsonld#ActorContextPreprocess_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_hash_bindings__5_0_0_components_ActorHashBindings_jsonld_ActorHashBindings_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-hash-bindings/^5.0.0/components/ActorHashBindings.jsonld#ActorHashBindings_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_hash_quads__5_0_0_components_ActorHashQuads_jsonld_ActorHashQuads_default_bus = new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_query_operation__5_0_0_components_ActorOptimizeQueryOperation_jsonld_ActorOptimizeQueryOperation_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-optimize-query-operation/^5.0.0/components/ActorOptimizeQueryOperation.jsonld#ActorOptimizeQueryOperation_default_bus'
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_dereference_rdf__5_0_0_components_ActorDereferenceRdf_jsonld_ActorDereferenceRdf_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-dereference-rdf/^5.0.0/components/ActorDereferenceRdf.jsonld#ActorDereferenceRdf_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join_entries_sort__5_0_0_components_ActorRdfJoinEntriesSort_jsonld_ActorRdfJoinEntriesSort_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-join-entries-sort/^5.0.0/components/ActorRdfJoinEntriesSort.jsonld#ActorRdfJoinEntriesSort_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join_selectivity__5_0_0_components_ActorRdfJoinSelectivity_jsonld_ActorRdfJoinSelectivity_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-join-selectivity/^5.0.0/components/ActorRdfJoinSelectivity.jsonld#ActorRdfJoinSelectivity_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata__5_0_0_components_ActorRdfMetadata_jsonld_ActorRdfMetadata_default_bus = new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_accumulate__5_0_0_components_ActorRdfMetadataAccumulate_jsonld_ActorRdfMetadataAccumulate_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-metadata-accumulate/^5.0.0/components/ActorRdfMetadataAccumulate.jsonld#ActorRdfMetadataAccumulate_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__5_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-metadata-extract/^5.0.0/components/ActorRdfMetadataExtract.jsonld#ActorRdfMetadataExtract_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse__5_0_0_components_ActorRdfParse_jsonld_ActorRdfParse_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-parse/^5.0.0/components/ActorRdfParse.jsonld#ActorRdfParse_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse_html__5_0_0_components_ActorRdfParseHtml_jsonld_ActorRdfParseHtml_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-parse-html/^5.0.0/components/ActorRdfParseHtml.jsonld#ActorRdfParseHtml_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links__5_0_0_components_ActorRdfResolveHypermediaLinks_jsonld_ActorRdfResolveHypermediaLinks_default_bus = new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links_queue__5_0_0_components_ActorRdfResolveHypermediaLinksQueue_jsonld_ActorRdfResolveHypermediaLinksQueue_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-resolve-hypermedia-links-queue/^5.0.0/components/ActorRdfResolveHypermediaLinksQueue.jsonld#ActorRdfResolveHypermediaLinksQueue_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize__5_0_0_components_ActorRdfSerialize_jsonld_ActorRdfSerialize_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-serialize/^5.0.0/components/ActorRdfSerialize.jsonld#ActorRdfSerialize_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_hypermedia__5_0_0_components_ActorRdfUpdateHypermedia_jsonld_ActorRdfUpdateHypermedia_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-update-hypermedia/^5.0.0/components/ActorRdfUpdateHypermedia.jsonld#ActorRdfUpdateHypermedia_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_quads__5_0_0_components_ActorRdfUpdateQuads_jsonld_ActorRdfUpdateQuads_default_bus = new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_bindings_aggregator_factory__5_0_0_components_ActorBindingsAggregatorFactory_jsonld_ActorBindingsAggregatorFactory_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-bindings-aggregator-factory/^5.0.0/components/ActorBindingsAggregatorFactory.jsonld#ActorBindingsAggregatorFactory_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_expression_evaluator_factory__5_0_0_components_ActorExpressionEvaluatorFactory_jsonld_ActorExpressionEvaluatorFactory_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-expression-evaluator-factory/^5.0.0/components/ActorExpressionEvaluatorFactory.jsonld#ActorExpressionEvaluatorFactory_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_function_factory__5_0_0_components_ActorFunctionFactory_jsonld_ActorFunctionFactory_default_bus = new (require('@comunica/bus-function-factory').BusFunctionFactory)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-function-factory/^5.0.0/components/ActorFunctionFactory.jsonld#ActorFunctionFactory_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http__5_0_0_components_ActorHttp_jsonld_ActorHttp_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-http/^5.0.0/components/ActorHttp.jsonld#ActorHttp_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http__5_0_0_components_ActorHttp_jsonld_ActorHttp_fallback_bus = new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_process__5_0_0_components_ActorQueryProcess_jsonld_ActorQueryProcess_default_bus = new (require('@comunica/core').Bus)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_source_identify__5_0_0_components_ActorQuerySourceIdentify_jsonld_ActorQuerySourceIdentify_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-query-source-identify/^5.0.0/components/ActorQuerySourceIdentify.jsonld#ActorQuerySourceIdentify_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join__5_0_0_components_ActorRdfJoin_jsonld_ActorRdfJoin_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-join/^5.0.0/components/ActorRdfJoin.jsonld#ActorRdfJoin_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_term_comparator_factory__5_0_0_components_ActorTermComparatorFactory_jsonld_ActorTermComparatorFactory_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-term-comparator-factory/^5.0.0/components/ActorTermComparatorFactory.jsonld#ActorTermComparatorFactory_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_merge_bindings_context__5_0_0_components_ActorMergeBindingsContext_jsonld_ActorMergeBindingsContext_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-merge-bindings-context/^5.0.0/components/ActorMergeBindingsContext.jsonld#ActorMergeBindingsContext_default_bus'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http_invalidate__5_0_0_components_ActorHttpInvalidate_jsonld_ActorHttpInvalidate_default_bus = new (require('@comunica/core').Bus)({
...
const urn_comunica_default_query_source_identify_hypermedia_mediators_main = new (require('@comunica/mediator-number').MediatorNumber)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_source_identify_hypermedia__5_0_0_components_ActorQuerySourceIdentifyHypermedia_jsonld_ActorQuerySourceIdentifyHypermedia_default_bus
});
...
const urn_comunica_default_hash_bindings_actors_murmur = new (require('@comunica/actor-hash-bindings-murmur').ActorHashBindingsMurmur)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_hash_bindings__5_0_0_components_ActorHashBindings_jsonld_ActorHashBindings_default_bus,
...
const urn_comunica_default_hash_quads_actors_murmur = new (require('@comunica/actor-hash-quads-murmur').ActorHashQuadsMurmur)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_hash_quads__5_0_0_components_ActorHashQuads_jsonld_ActorHashQuads_default_bus,
...
const urn_comunica_default_optimize_query_operation_actors_rewrite_copy = new (require('@comunica/actor-optimize-query-operation-rewrite-copy').ActorOptimizeQueryOperationRewriteCopy)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_query_operation__5_0_0_components_ActorOptimizeQueryOperation_jsonld_ActorOptimizeQueryOperation_default_bus,
...
const urn_comunica_default_dereference_actors_fallback = new (require('@comunica/actor-dereference-fallback').ActorDereferenceFallback)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_dereference__5_0_0_components_ActorDereference_jsonld_ActorDereference_default_bus,
...
const urn_comunica_default_dereference_rdf_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_dereference_rdf__5_0_0_components_ActorDereferenceRdf_jsonld_ActorDereferenceRdf_default_bus
});
const urn_comunica_default_rdf_join_entries_sort_actors_cardinality = new (require('@comunica/actor-rdf-join-entries-sort-cardinality').ActorRdfJoinEntriesSortCardinality)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join_entries_sort__5_0_0_components_ActorRdfJoinEntriesSort_jsonld_ActorRdfJoinEntriesSort_default_bus,
...
const urn_comunica_default_rdf_join_selectivity_actors_variable_counting = new (require('@comunica/actor-rdf-join-selectivity-variable-counting').ActorRdfJoinSelectivityVariableCounting)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join_selectivity__5_0_0_components_ActorRdfJoinSelectivity_jsonld_ActorRdfJoinSelectivity_default_bus,
...
const urn_comunica_default_rdf_metadata_actors_primary_topic = new (require('@comunica/actor-rdf-metadata-primary-topic').ActorRdfMetadataPrimaryTopic)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata__5_0_0_components_ActorRdfMetadata_jsonld_ActorRdfMetadata_default_bus,
...
const urn_comunica_default_rdf_metadata_accumulate_actors_cardinality = new (require('@comunica/actor-rdf-metadata-accumulate-cardinality').ActorRdfMetadataAccumulateCardinality)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_accumulate__5_0_0_components_ActorRdfMetadataAccumulate_jsonld_ActorRdfMetadataAccumulate_default_bus,
...
const urn_comunica_default_rdf_metadata_extract_actors_hydra_controls = new (require('@comunica/actor-rdf-metadata-extract-hydra-controls').ActorRdfMetadataExtractHydraControls)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__5_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus,
...
const urn_comunica_default_rdf_metadata_extract_actors_post_accepted = new (require('@comunica/actor-rdf-metadata-extract-post-accepted').ActorRdfMetadataExtractPostAccepted)({
  'name': 'urn:comunica:default:rdf-metadata-extract/actors#post-accepted',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__5_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus,
  'busFailMessage': 'Metadata extraction failed: none of the configured actors were able to extract metadata from ${action.url}'
});
...
const urn_comunica_default_rdf_metadata_extract_actors_void = new (require('@comunica/actor-rdf-metadata-extract-void').ActorRdfMetadataExtractVoid)({
  'name': 'urn:comunica:default:rdf-metadata-extract/actors#void',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__5_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus,
  'busFailMessage': 'Metadata extraction failed: none of the configured actors were able to extract metadata from ${action.url}'
});
const urn_comunica_default_rdf_metadata_extract_actors_server_software = new (require('@comunica/actor-rdf-metadata-extract-server-software').ActorRdfMetadataExtractServerSoftware)({
  'name': 'urn:comunica:default:rdf-metadata-extract/actors#server-software',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_metadata_extract__5_0_0_components_ActorRdfMetadataExtract_jsonld_ActorRdfMetadataExtract_default_bus,
  'busFailMessage': 'Metadata extraction failed: none of the configured actors were able to extract metadata from ${action.url}'
});
...
const urn_comunica_default_rdf_parse_actors_n3 = new (require('@comunica/actor-rdf-parse-n3').ActorRdfParseN3)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse__5_0_0_components_ActorRdfParse_jsonld_ActorRdfParse_default_bus,
...
const urn_comunica_default_rdf_parse_actors_html = new (require('@comunica/actor-rdf-parse-html').ActorRdfParseHtml)({
  'busRdfParseHtml': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse_html__5_0_0_components_ActorRdfParseHtml_jsonld_ActorRdfParseHtml_default_bus,
...
const urn_comunica_default_rdf_parse_html_actors_microdata = new (require('@comunica/actor-rdf-parse-html-microdata').ActorRdfParseHtmlMicrodata)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_parse_html__5_0_0_components_ActorRdfParseHtml_jsonld_ActorRdfParseHtml_default_bus,
...
const urn_comunica_default_rdf_resolve_hypermedia_links_actors_next = new (require('@comunica/actor-rdf-resolve-hypermedia-links-next').ActorRdfResolveHypermediaLinksNext)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links__5_0_0_components_ActorRdfResolveHypermediaLinks_jsonld_ActorRdfResolveHypermediaLinks_default_bus,
...
const urn_comunica_default_rdf_resolve_hypermedia_links_queue_actors_fifo = new (require('@comunica/actor-rdf-resolve-hypermedia-links-queue-fifo').ActorRdfResolveHypermediaLinksQueueFifo)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_resolve_hypermedia_links_queue__5_0_0_components_ActorRdfResolveHypermediaLinksQueue_jsonld_ActorRdfResolveHypermediaLinksQueue_default_bus,
  'busFailMessage': 'Link queue creation failed: none of the configured actors were able to create a link queue'
});
...
const urn_comunica_default_rdf_serialize_actors_n3 = new (require('@comunica/actor-rdf-serialize-n3').ActorRdfSerializeN3)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize__5_0_0_components_ActorRdfSerialize_jsonld_ActorRdfSerialize_default_bus,
...
const urn_comunica_default_rdf_update_hypermedia_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_hypermedia__5_0_0_components_ActorRdfUpdateHypermedia_jsonld_ActorRdfUpdateHypermedia_default_bus
});
const urn_comunica_default_rdf_update_quads_actors_rdfjs_store = new (require('@comunica/actor-rdf-update-quads-rdfjs-store').ActorRdfUpdateQuadsRdfJsStore)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_update_quads__5_0_0_components_ActorRdfUpdateQuads_jsonld_ActorRdfUpdateQuads_default_bus,
...
const urn_comunica_default_bindings_aggregator_factory_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_bindings_aggregator_factory__5_0_0_components_ActorBindingsAggregatorFactory_jsonld_ActorBindingsAggregatorFactory_default_bus
});
const urn_comunica_default_expression_evaluator_factory_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_expression_evaluator_factory__5_0_0_components_ActorExpressionEvaluatorFactory_jsonld_ActorExpressionEvaluatorFactory_default_bus
});
...
const urn_comunica_default_function_factory_actors_term_function_has_lang = new (require('@comunica/actor-function-factory-term-has-lang').ActorFunctionFactoryTermHasLang)({
  'name': 'urn:comunica:default:function-factory/actors#term-function-has-lang',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_function_factory__5_0_0_components_ActorFunctionFactory_jsonld_ActorFunctionFactory_default_bus,
  'busFailMessage': 'Creation of function evaluator failed: no configured actor was able to evaluate function ${action.functionName}'
});
const urn_comunica_default_function_factory_actors_term_function_has_langdir = new (require('@comunica/actor-function-factory-term-has-langdir').ActorFunctionFactoryTermHasLangdir)({
  'name': 'urn:comunica:default:function-factory/actors#term-function-has-langdir',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_function_factory__5_0_0_components_ActorFunctionFactory_jsonld_ActorFunctionFactory_default_bus,
  'busFailMessage': 'Creation of function evaluator failed: no configured actor was able to evaluate function ${action.functionName}'
});
...
const urn_comunica_default_function_factory_actors_term_function_langdir = new (require('@comunica/actor-function-factory-term-langdir').ActorFunctionFactoryTermLangdir)({
  'name': 'urn:comunica:default:function-factory/actors#term-function-langdir',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_function_factory__5_0_0_components_ActorFunctionFactory_jsonld_ActorFunctionFactory_default_bus,
  'busFailMessage': 'Creation of function evaluator failed: no configured actor was able to evaluate function ${action.functionName}'
});
...
const urn_comunica_default_function_factory_actors_term_function_str_langdir = new (require('@comunica/actor-function-factory-term-str-langdir').ActorFunctionFactoryTermStrLangdir)({
  'name': 'urn:comunica:default:function-factory/actors#term-function-str-langdir',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_function_factory__5_0_0_components_ActorFunctionFactory_jsonld_ActorFunctionFactory_default_bus,
  'busFailMessage': 'Creation of function evaluator failed: no configured actor was able to evaluate function ${action.functionName}'
});
...
const urn_comunica_default_http_mediators_no_fallback = new (require('@comunica/mediator-number').MediatorNumber)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http__5_0_0_components_ActorHttp_jsonld_ActorHttp_default_bus
});
const urn_comunica_default_http_mediators_main = new (require('@comunica/mediator-number').MediatorNumber)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http__5_0_0_components_ActorHttp_jsonld_ActorHttp_fallback_bus
});
const urn_comunica_default_query_process_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_process__5_0_0_components_ActorQueryProcess_jsonld_ActorQueryProcess_default_bus
});
const urn_comunica_default_query_source_identify_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_source_identify__5_0_0_components_ActorQuerySourceIdentify_jsonld_ActorQuerySourceIdentify_default_bus
});
const urn_comunica_default_rdf_join_mediators_main = new (require('@comunica/mediator-join-coefficients-fixed').MediatorJoinCoefficientsFixed)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_join__5_0_0_components_ActorRdfJoin_jsonld_ActorRdfJoin_default_bus
});
const urn_comunica_default_term_comparator_factory_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_term_comparator_factory__5_0_0_components_ActorTermComparatorFactory_jsonld_ActorTermComparatorFactory_default_bus
});
const urn_comunica_default_merge_bindings_context_mediators_main = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_merge_bindings_context__5_0_0_components_ActorMergeBindingsContext_jsonld_ActorMergeBindingsContext_default_bus
});
const urn_comunica_default_http_invalidate_mediators_main = new (require('@comunica/mediator-all').MediatorAll)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http_invalidate__5_0_0_components_ActorHttpInvalidate_jsonld_ActorHttpInvalidate_default_bus
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_optimize_query_operation_query_source_identify__5_0_0_components_ActorOptimizeQueryOperationQuerySourceIdentify_jsonld_IActorOptimizeQueryOperationQuerySourceIdentifyArgs_default_invalidator = new (require('@comunica/bus-http-invalidate').ActorHttpInvalidateListenable)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_rdf_parse_jsonld__5_0_0_components_ActorRdfParseJsonLd_jsonld_IActorRdfParseJsonLdArgs_default_invalidator = new (require('@comunica/bus-http-invalidate').ActorHttpInvalidateListenable)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_rdf_update_quads_hypermedia__5_0_0_components_ActorRdfUpdateQuadsHypermedia_jsonld_IActorRdfUpdateQuadsHypermediaArgs_default_invalidator = new (require('@comunica/bus-http-invalidate').ActorHttpInvalidateListenable)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_http_retry__5_0_0_components_ActorHttpRetry_jsonld_IActorHttpQueueArgs_default_invalidator = new (require('@comunica/bus-http-invalidate').ActorHttpInvalidateListenable)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_http_fetch__5_0_0_components_ActorHttpFetch_jsonld_IActorHttpFetchArgs_default_invalidator = new (require('@comunica/bus-http-invalidate').ActorHttpInvalidateListenable)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_http_limit_rate__5_0_0_components_ActorHttpLimitRate_jsonld_IActorHttpLimitRateArgs_default_invalidator = new (require('@comunica/bus-http-invalidate').ActorHttpInvalidateListenable)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_sparql_json__5_0_0_components_ActionObserverHttp_jsonld_IActionObserverHttpArgs_default_invalidator = new (require('@comunica/bus-http-invalidate').ActorHttpInvalidateListenable)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_stats__5_0_0_components_ActionObserverHttp_jsonld_IActionObserverHttpArgs_default_invalidator = new (require('@comunica/bus-http-invalidate').ActorHttpInvalidateListenable)({
...
const urn_comunica_default_query_operation_actors_nodes = new (require('@comunica/actor-query-operation-nodes').ActorQueryOperationNodes)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
...
const urn_comunica_default_rdf_join_entries_sort_actors_selectivity = new (require('@comunica/actor-rdf-join-entries-sort-selectivity').ActorRdfJoinEntriesSortSelectivity)({
...
const urn_comunica_default_query_source_dereference_link_actors_dereference = new (require('@comunica/actor-query-source-dereference-link-hypermedia').ActorQuerySourceDereferenceLinkHypermedia)({
  ...
  'name': 'urn:comunica:default:query-source-dereference-link/actors#dereference',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_source_dereference_link__5_0_0_components_ActorQuerySourceDereferenceLink_jsonld_ActorQuerySourceDereferenceLink_default_bus,
...
const urn_comunica_default_query_source_identify_hypermedia_actors_wisekg = new (require('@comunica/actor-query-source-identify-hypermedia-wisekg').ActorQuerySourceIdentifyHypermediaWiseKg)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
  'mediatorQuerySourceDereferenceLink': urn_comunica_default_query_source_dereference_link_mediators_main,
  'name': 'urn:comunica:default:query-source-identify-hypermedia/actors#wisekg',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_source_identify_hypermedia__5_0_0_components_ActorQuerySourceIdentifyHypermedia_jsonld_ActorQuerySourceIdentifyHypermedia_default_bus,
...
const urn_comunica_default_optimize_query_operation_actors_distinct_terms_pushdown = new (require('@comunica/actor-optimize-query-operation-distinct-terms-pushdown').ActorOptimizeQueryOperationDistinctTermsPushdown)({
...
const urn_comunica_default_query_source_identify_hypermedia_actors_spf = new (require('@comunica/actor-query-source-identify-hypermedia-spf').ActorQuerySourceIdentifyHypermediaSpf)({
  'mediatorMetadata': urn_comunica_default_rdf_metadata_mediators_main,
  'mediatorMetadataExtract': urn_comunica_default_rdf_metadata_extract_mediators_main,
  'mediatorDereferenceRdf': urn_comunica_default_dereference_rdf_mediators_main,
  'mediatorMergeBindingsContext': urn_comunica_default_merge_bindings_context_mediators_main,
  'maxMpR': 30,
  'name': 'urn:comunica:default:query-source-identify-hypermedia/actors#spf',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_source_identify_hypermedia__5_0_0_components_ActorQuerySourceIdentifyHypermedia_jsonld_ActorQuerySourceIdentifyHypermedia_default_bus,
  'busFailMessage': 'Query source hypermedia identification failed: none of the configured actors were able to identify ${action.url}'
});
...
const urn_comunica_default_query_source_identify_hypermedia_actors_sparql = new (require('@comunica/actor-query-source-identify-hypermedia-sparql').ActorQuerySourceIdentifyHypermediaSparql)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
  'mediatorMergeBindingsContext': urn_comunica_default_merge_bindings_context_mediators_main,
  'mediatorQuerySerialize': urn_comunica_default_query_serialize_mediators_main,
  'checkUrlSuffix': true,
  'forceHttpGet': false,
  'cacheSize': 1024,
...
const urn_comunica_default_init_actors_query = new (require('@comunica/actor-init-query').ActorInitQuery)({
  ...
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_init__5_0_0_components_ActorInit_jsonld_ActorInit_default_bus,
...
const urn_comunica_default_rdf_parse_actors_jsonld = new (require('@comunica/actor-rdf-parse-jsonld').ActorRdfParseJsonLd)({
  'cacheSize': 128,
  'httpInvalidator': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_rdf_parse_jsonld__5_0_0_components_ActorRdfParseJsonLd_jsonld_IActorRdfParseJsonLdArgs_default_invalidator,
  'mediatorHttp': urn_comunica_default_http_mediators_main,
...
const urn_comunica_default_rdf_update_quads_actors_hypermedia = new (require('@comunica/actor-rdf-update-quads-hypermedia').ActorRdfUpdateQuadsHypermedia)({
  'cacheSize': 100,
  'httpInvalidator': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_rdf_update_quads_hypermedia__5_0_0_components_ActorRdfUpdateQuadsHypermedia_jsonld_IActorRdfUpdateQuadsHypermediaArgs_default_invalidator,
  'mediatorDereferenceRdf': urn_comunica_default_dereference_rdf_mediators_main,
  'mediatorMetadata': urn_comunica_default_rdf_metadata_mediators_main,
  'mediatorMetadataExtract': urn_comunica_default_rdf_metadata_extract_mediators_main,
...
const urn_comunica_default_http_actors_fetch = new (require('@comunica/actor-http-fetch').ActorHttpFetch)({
  ...
  'httpInvalidator': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_http_fetch__5_0_0_components_ActorHttpFetch_jsonld_IActorHttpFetchArgs_default_invalidator,
  'agentOptions': {"keepAlive":true,"maxSockets":5},
  'name': 'urn:comunica:default:http/actors#fetch',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_http__5_0_0_components_ActorHttp_jsonld_ActorHttp_default_bus,
  'busFailMessage': 'HTTP request failed: none of the configured actors were able to handle ${action.input}'
});
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_sparql_json__5_0_0_components_ActorQueryResultSerializeSparqlJson_jsonld_ActorQueryResultSerializeSparqlJson_default_observer = new (require('@comunica/actor-query-result-serialize-sparql-json').ActionObserverHttp)({
  'httpInvalidator': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_sparql_json__5_0_0_components_ActionObserverHttp_jsonld_IActionObserverHttpArgs_default_invalidator,
  'observedActors': [
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_stats__5_0_0_components_ActorQueryResultSerializeStats_jsonld_ActorQueryResultSerializeStats_default_observer = new (require('@comunica/actor-query-result-serialize-stats').ActionObserverHttp)({
  'httpInvalidator': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_stats__5_0_0_components_ActionObserverHttp_jsonld_IActionObserverHttpArgs_default_invalidator,
  'observedActors': [
  'urn:comunica:default:http/actors#fetch'
],
...
const urn_comunica_default_query_operation_actors_wisekg_bgp = new (require('@comunica/actor-query-operation-bgp-wisekg').ActorQueryOperationBgpWiseKg)({
  'mediatorQueryOperation': urn_comunica_default_query_operation_mediators_main,
  'name': 'urn:comunica:default:query-operation/actors#wisekg-bgp',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_query_operation__5_0_0_components_ActorQueryOperation_jsonld_ActorQueryOperation_default_bus,
  'busFailMessage': 'Query operation processing failed: none of the configured actors were able to handle the operation type ${action.operation.type}',
  'beforeActors': [
...
const urn_comunica_default_query_source_dereference_link_actors_force_sparql = new (require('@comunica/actor-query-source-dereference-link-force-sparql').ActorQuerySourceDereferenceLinkForceSparql)({
  'mediatorMetadataAccumulate': urn_comunica_default_rdf_metadata_accumulate_mediators_main,
  'mediatorQuerySourceIdentifyHypermedia': urn_comunica_default_query_source_identify_hypermedia_mediators_main,
...
const urn_comunica_default_query_process_actors_explain_query = new (require('@comunica/actor-query-process-explain-query').ActorQueryProcessExplainQuery)({
  'queryProcessor': urn_comunica_default_query_process_actors_sequential,
  'mediatorQuerySerialize': urn_comunica_default_query_serialize_mediators_main,
...
const urn_comunica_default_query_result_serialize_actors_sparql_json = new (require('@comunica/actor-query-result-serialize-sparql-json').ActorQueryResultSerializeSparqlJson)({
  'emitMetadata': true,
  'httpObserver': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_sparql_json__5_0_0_components_ActorQueryResultSerializeSparqlJson_jsonld_ActorQueryResultSerializeSparqlJson_default_observer,
...
const urn_comunica_default_query_result_serialize_actors_stats = new (require('@comunica/actor-query-result-serialize-stats').ActorQueryResultSerializeStats)({
  'httpObserver': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_query_result_serialize_stats__5_0_0_components_ActorQueryResultSerializeStats_jsonld_ActorQueryResultSerializeStats_default_observer,
...
const urn_comunica_default_optimize_query_operation_actors_leftjoin_expression_pushdown = new (require('@comunica/actor-optimize-query-operation-leftjoin-expression-pushdown').ActorOptimizeQueryOperationLeftjoinExpressionPushdown)({
...
const urn_comunica_default_http_actors_retry = new (require('@comunica/actor-http-retry').ActorHttpRetry)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
  'httpInvalidator': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_http_retry__5_0_0_components_ActorHttpRetry_jsonld_IActorHttpQueueArgs_default_invalidator,
...
const urn_comunica_default_http_actors_limit_rate = new (require('@comunica/actor-http-limit-rate').ActorHttpLimitRate)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
  'httpInvalidator': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_http_limit_rate__5_0_0_components_ActorHttpLimitRate_jsonld_IActorHttpLimitRateArgs_default_invalidator,
...
const urn_comunica_default_http_actors_retry_body = new (require('@comunica/actor-http-retry-body').ActorHttpRetryBody)({
  'mediatorHttp': urn_comunica_default_http_mediators_main,
...
const urn_comunica_default_optimize_query_operation_actors_assign_sources_exhaustive = new (require('@comunica/actor-optimize-query-operation-assign-sources-exhaustive').ActorOptimizeQueryOperationAssignSourcesExhaustive)({
  ...
  urn_comunica_default_optimize_query_operation_actors_distinct_terms_pushdown
]
});
const urn_comunica_default_optimize_query_operation_actors_query_source_skolemize = new (require('@comunica/actor-optimize-query-operation-query-source-skolemize').ActorOptimizeQueryOperationQuerySourceSkolemize)({
  'name': 'urn:comunica:default:optimize-query-operation/actors#query-source-skolemize',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_query_operation__5_0_0_components_ActorOptimizeQueryOperation_jsonld_ActorOptimizeQueryOperation_default_bus,
  'busFailMessage': 'Query optimization failed: none of the configured actors were able to optimize',
  'beforeActors': [
...
const urn_comunica_default_optimize_query_operation_actors_query_source_identify = new (require('@comunica/actor-optimize-query-operation-query-source-identify').ActorOptimizeQueryOperationQuerySourceIdentify)({
  'serviceForceSparqlEndpoint': false,
  'cacheSize': 100,
  'httpInvalidator': https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_optimize_query_operation_query_source_identify__5_0_0_components_ActorOptimizeQueryOperationQuerySourceIdentify_jsonld_IActorOptimizeQueryOperationQuerySourceIdentifyArgs_default_invalidator,
  'mediatorQuerySourceIdentify': urn_comunica_default_query_source_identify_mediators_main,
  'mediatorContextPreprocess': urn_comunica_default_context_preprocess_mediators_main,
  'name': 'urn:comunica:default:optimize-query-operation/actors#query-source-identify',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_optimize_query_operation__5_0_0_components_ActorOptimizeQueryOperation_jsonld_ActorOptimizeQueryOperation_default_bus,
  'busFailMessage': 'Query optimization failed: none of the configured actors were able to optimize',
  'beforeActors': [
  urn_comunica_default_optimize_query_operation_actors_query_source_skolemize
]
});
const urn_comunica_default_optimize_query_operation_actors_describe_to_constructs_subject = new (require('@comunica/actor-optimize-query-operation-describe-to-constructs-subject').ActorOptimizeQueryOperationDescribeToConstructsSubject)({
  ...
  'busFailMessage': 'Query optimization failed: none of the configured actors were able to optimize',
  'beforeActors': [
  urn_comunica_default_optimize_query_operation_actors_query_source_identify
]
});
const urn_comunica_default_Runner = (https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_init__5_0_0_components_ActorInit_jsonld_ActorInit_default_bus, [
  urn_comunica_default_query_source_identify_hypermedia_actors_spf,
  urn_comunica_default_query_operation_actors_wisekg_bgp,
  urn_comunica_default_query_source_identify_hypermedia_actors_wisekg,
  ...
  urn_comunica_default_optimize_query_operation_actors_join_connected,
  urn_comunica_default_optimize_query_operation_actors_prune_empty_source_operations,
  urn_comunica_default_optimize_query_operation_actors_leftjoin_expression_pushdown,
  urn_comunica_default_optimize_query_operation_actors_filter_pushdown,
  urn_comunica_default_optimize_query_operation_actors_distinct_terms_pushdown,
  urn_comunica_default_optimize_query_operation_actors_group_sources,
  ...
  urn_comunica_default_rdf_metadata_extract_actors_post_accepted,
  ...
  urn_comunica_default_rdf_metadata_extract_actors_server_software,
  ...
  urn_comunica_default_function_factory_actors_term_function_langdir,
  ...
  urn_comunica_default_function_factory_actors_term_function_str_langdir,
  ...
  urn_comunica_default_http_actors_retry_body,
  urn_comunica_default_http_actors_retry,
  urn_comunica_default_http_actors_proxy,
  urn_comunica_default_http_actors_fetch,
  ...
  urn_comunica_default_query_process_actors_explain_query,
